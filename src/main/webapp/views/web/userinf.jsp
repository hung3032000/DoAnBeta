			...
			<div class="registration container">
				<c:if test="${not empty ready}">
					<div class="account-edit-success">
						<i class="icon_CheckMark"> </i> <span role="alert">
							${message} </span>
					</div>
				</c:if>
						...
						<form action="${pageContext.request.contextPath}/user-update"
							...
							<fieldset>
										...
										<div class="form-field">
											<div class="form-select-wrapper">
												<select class="form-select title form-field required"
													...
													value="dcm"><option class="form-selectOption"
														label="Title" value="Title">Title</option>
								...
								<div class="form-row firstname required empty focus"
									...
									<div class="form-field">
										<input class="form-input firstname form-field required"
											...
											name="cus_fname" value="${USERMODEL.fName}" maxlength="13"
								...
								<div class="form-row lastname required empty focus"
									...
									<div class="form-field">
										<input class="form-input lastname form-field required"
											type="text" id="dwfrm_profile_customer_lastname_d0nvjfwfdkjp"
											name="cus_lname" value="${USERMODEL.lName}" maxlength="13"
											...
											<div class="form-field">
												<div class="form-select-wrapper">
													<select class="form-select daybirthday"
														...
														name="cus_daybirthday" data-dwname="daybirthday"
														autocomplete="bday-day" aria-label="Birthday Day"><option
											...
											<div class="form-field">
												<div class="form-select-wrapper">
													<select class="form-select monthbirthday"
														...
														name="cus_monthbirthday" data-dwname="monthbirthday"
														autocomplete="bday-month" aria-label="Month"><option
											...
											<div class="form-field">
												<div class="form-select-wrapper">
													<select class="form-select yearbirthday"
														...
														name="cus_yearbirthday" data-dwname="yearbirthday"
														autocomplete="bday-month" aria-label="Year"><option
								...
								<div class="form-row required"
									...
									<div class="form-field">
										<input class="form-input email form-field required"
											...
											name="cus_email" value="${USERMODEL.email}" maxlength="50"
											data-dwname="email" disabled="disabled" aria-required="true">
									</div>
								...
								<div class="form-row form-row-button">
									...
									<button type="submit" value="update" name="action">Save
										changes</button>
								</div>
								...
								<div class="form-row form-row-button">
									<input type="hidden" value="${USERMODEL.email}" name="email" />
									<button type="submit" class="delete-account" value="delete"
										name="action">Delete account</button>
								</div>


							</fieldset>
						</form>
						<form action="${pageContext.request.contextPath}/user-resetpass"
							method="post" class="form-horizontal" id="ChangePassowrdForm"
							...
							<fieldset>
								...
								<div class="form-row required empty" data-requiredtext=""
									...
									<div class="form-field">
										<input class="form-input currentpassword form-field required"
											...
											data-dwname="currentpassword" autocomplete="current-password"
											aria-required="true">
									</div>
								...
								<div class="form-row required empty" data-requiredtext=""
									...
									<div class="form-field">
										<input class="form-input newpassword form-field required"
											...
											name="cus_newpass" maxlength="14" data-dwname="newpassword"
								...
								<div class="form-row required empty" data-requiredtext=""
									...
									<div class="form-caption"
										...
										password containing at least 8 characters, with 1 number and 1
								...
								<div class="form-row required empty" data-requiredtext=""
									...
									<div class="form-field">
										<input
											...
											name="cus_confnewpass" value="" maxlength="14"
											data-dwname="newpasswordconfirm"
								...
								<input type="hidden" name="cus_email" value="${USERMODEL.email}">
							</fieldset>
						</form>
					</div>
				</div>
