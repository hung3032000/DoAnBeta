...
ALTER TABLE `product` ADD FOREIGN KEY (`categorie_id`) REFERENCES `categories` (`id`) on delete cascade;

ALTER TABLE `users` ADD FOREIGN KEY (`role_id`) REFERENCES `role` (`id`) on delete cascade;

ALTER TABLE `orders` ADD FOREIGN KEY (`user_email`) REFERENCES `users` (`email`) on delete cascade;

ALTER TABLE `customer` ADD FOREIGN KEY (`user_email`) REFERENCES `users` (`email`) on delete cascade;
